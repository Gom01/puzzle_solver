...
def side_similarities(side1, side2, window=False):
    ...
    # Test normal, reversed, and 180° rotated versions
    for variant in [parsed_2, parsed_2[::-1], -parsed_2, -parsed_2[::-1]]:
        aligned_2 = normalize_curve(align_contour_to_side_axis(variant))
